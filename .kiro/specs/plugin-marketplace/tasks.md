...
- [ ] 2. Wire Chain into the Flight loop
...
- [ ] 4. wazero Host: compile + instantiate + invoke
...
- [ ] 5. Capability broker (host functions)
...
- [ ] 7. Reference guest SDK + sample plugin
...
- [ ] 8. Bundle format + manifest schema + detached signing
...
- [ ] 9. Registry storage + publisher model (BFF)
...
- [ ] 10. Install records + capability consent + lockfile (BFF)
...
- [ ] 11. Assembly + SessionConfig wiring
...
- [ ] 12. Runtime resolution + content-addressed cache
...
- [ ] 15. Installed-plugins management
