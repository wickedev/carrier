...
export function UsagePill({
  ...
  return (
    <span
      className={cn(
        "inline-flex items-center gap-1 rounded border border-neutral-200 px-1.5 py-0.5 text-[11px] text-neutral-600 dark:border-neutral-700 dark:text-neutral-300",
        className,
      )}
